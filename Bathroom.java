...
public class Bathroom extends Activity{
  ...
  public boolean Bathroom(){
    System.out.println("You enter the restroom. Just as you open the door, a stench hits you straign in the face. \n Reeling from the smell, you debate on whether to continue. (1 to hold it in or 2 to brave the stench.)");
