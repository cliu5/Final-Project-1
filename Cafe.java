...
public class Cafe extends Activity{
  public void PlayActivity(Player x) {
    boolean result = Cafe();
    if (result){
      System.out.println("You decide to wait on the lunch line. At first, the lunch lines move at a slow but steady rate. But then, the flow of people caught up with the serving speed of the lunch ladies and slowed down to a snail's crawl. Taking into consideration the time needed and the miniscule size of the portions, you proceed upstairs.");
    }else{
