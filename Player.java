...
public Player(){
  ...
  Floor1.add("Theater");
  Floor1.add("You burst through the entrance and find yourself on the 1st Floor of Stuyvesant High School. Before you, you see fallen students with papers on the floor. They all seem to be pointing in the general direction of the Band Room and Theater. Do you proceed to 1. the Band Room OR 2. the Theater?");
  Floor2.add("Guidance Office");
  Floor2.add("Museum Room");
  Floor2.add("You have now arrived on the second floor. Once again, there is chaos everywhere. The chaos seems to pointing towards the Guidance Room and Museum Room. Do you proceed to the 1. Guidance Room OR 2. Museum Room?");
  Floor3.add("CS Room");
  Floor3.add("Bathroom");
  Floor3 .add("Now arriving on the 3rd floor, do you feel the need to empty your bladder before continuing, or go straight to the CS room, where the distubance seems to be? Are you proceeding to the 1. Computer Science Lab OR 2. Bathroom?");
  ...
  Floor5.add("Climbing up the stairs between the 4th and 5th floor, you see that the thief had not stopped on the 5th floor and decided to proceed directly to the 6th floor. You are a bit hungry after the long chase. Do you chose to 1. grab some grub in the Cafeteria OR 2. proceed directly to 6th floor?");
  Floor6.add("Gymnasium");
  Floor6.add("Speech and Debate Club");
  Floor6.add("Now that you are on the 6th floor, you hear commotions on two opposite sites. One is in the direction of the 6th floor gymnasium and the other is in the direction of the Stuyvesant Speech and Debate Club. Towards which commotion do you proceed towards? 1. Gymnasium OR 2. Speech and Debate Club?");
  ...
  Floor8.add("Bench");
  Floor8.add("You are nearly at the top of Stuyvesant High School. As you wipe your sweat from from your brows, you walk across the 8th Floor. As you walk, you see a bench and hear a large sound that originated from a physics lab. Do you (1) take a rest on the bench OR (2) go straight to the laboratory and check \n out what occured?");
